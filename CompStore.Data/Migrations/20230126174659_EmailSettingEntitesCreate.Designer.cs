...
namespace CompStore.Data.Migrations
{
    ...
    [Migration("20230126174659_EmailSettingEntitesCreate")]
    partial class EmailSettingEntitesCreate
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CompStore.Core.Entites.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CompStore.Core.Entites.DaxiliYaddaş", b =>
                {
                    ...
                    b.ToTable("DaxiliYaddaşs");
                });

            modelBuilder.Entity("CompStore.Core.Entites.EmailSetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CompStore.Core.Entites.ImageSetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CompStore.Core.Entites.MainSlider", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CompStore.Core.Entites.MainSpecialBox", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CompStore.Core.Entites.ScreenFrequency", b =>
                {
                    ...
                    b.ToTable("ScreenFrequencies");
                });

            modelBuilder.Entity("CompStore.Core.Entites.Setting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CompStore.Core.Entites.Subscribe", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CompStore.Core.Entites.VideokartRam", b =>
                {
                    ...
                    b.ToTable("VideokartRams");
                });

            modelBuilder.Entity("CompStore.Core.Entites.WishItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
