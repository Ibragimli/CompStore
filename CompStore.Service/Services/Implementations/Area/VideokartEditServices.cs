...
namespace CompStore.Service.Services.Implementations.Area
{
    public class VideokartEditServices : IVideokartEditServices
    {
        ...
        public async Task VideokartEdit(VideokartEditDto VideokartEdit)
        {
            ...
            if (await _unitOfWork.VideokartRepository.IsExistAsync(x => x.Name == VideokartEdit.Name && x.Id != VideokartEdit.Id))
            ...
            lastVideokart.ModifiedDate = DateTime.UtcNow.AddHours(4);
